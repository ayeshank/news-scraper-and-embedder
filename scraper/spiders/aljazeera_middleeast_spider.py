...
@SpiderFactory.register('Aljazeera_Middleeast_Spider')
class Aljazeera_Middleeast_Spider(scrapy.Spider):
    name = "AlJazeera_Middle_East"

    def __init__(self, *args, **kwargs):
        self.url = kwargs.get('url', 'https://www.aljazeera.com/middle-east/')
