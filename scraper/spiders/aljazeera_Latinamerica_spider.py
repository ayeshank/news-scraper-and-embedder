...
@SpiderFactory.register('Aljazeera_Latinamerica_Spider')
class Aljazeera_Latinamerica_Spider(scrapy.Spider):
    name = "AlJazeera_Latinamerica"

    def __init__(self, *args, **kwargs):
        self.url = kwargs.get('url', 'https://www.aljazeera.com/latin-america/')
