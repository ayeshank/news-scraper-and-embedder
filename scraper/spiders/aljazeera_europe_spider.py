...
@SpiderFactory.register('Aljazeera_Europe_Spider')
class Aljazeera_Europe_Spider(scrapy.Spider):
    name = "AlJazeera_Europe"

    def __init__(self, *args, **kwargs):
        self.url = kwargs.get('url', 'https://www.aljazeera.com/europe/')
